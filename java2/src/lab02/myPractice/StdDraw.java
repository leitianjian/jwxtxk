...
*/
    ...
    ***************************************************************************/
    ...
    public static void text (double x, double y, String s, double degrees, Color bgc) {
        double xs = scaleX( x);
        double ys = scaleY( y);
        offscreen.rotate( Math.toRadians(-degrees), xs, ys);
        ...
        if (bgc != null) {
            TextLayout layout = new TextLayout( 
                s, getFont(), offscreen.getFontRenderContext()
            );
            ...
            // offscreen.drawString(text, (float) (xs - ws/2.0), (float) (ys + hs));
            bounds.setRect( 
                bounds.getX() + xs - bounds.getWidth()/2,
                bounds.getY() + ys - hs + bounds.getHeight()/2,
                bounds.getWidth(),
                bounds.getHeight()
            );
            Color preColor = getPenColor();
            setPenColor( bgc);
            offscreen.fill( bounds);
            draw();
    ...
    *  as an argument. It can handle action keys
    ...
    public static void main(String[] args) {
        ...
        StdDraw.setPenColor(StdDraw.BLACK);
        StdDraw.text(0.2, 0.5, "bdfdfdfdlack text");
        StdDraw.setPenColor(StdDraw.WHITE);
        StdDraw.text(0.8, 0.8, "white text");

        Font font = new Font("SansSerif", Font.BOLD, 120);
        StdDraw.setFont( font);
        StdDraw.text(0.3, 0.4, "Hello", 10.0, Color.YELLOW);

        StdDraw.setPenColor( Color.BLUE);
        font = new Font("����", Font.PLAIN, 80);
        StdDraw.setFont( font);
        StdDraw.text( 0.3, 0.4, "�Ƽ�����", 0.0, Color.YELLOW);

        StdDraw.setPenColor( Color.BLUE);
        StdDraw.text( 0.3, 0.55, "���Ĳ���", 20.0, null);
        StdDraw.text( 0.3, 0.70,"���ֲ���", 20.0, Color.BLACK );

        font = new Font("SansSerif", Font.BOLD, 40);
        StdDraw.setFont( font);
        StdDraw.setPenColor( new Color(211, 255, 241) );
        StdDraw.text( 0.2, 0.7, "World", -10.0 );
        StdDraw.text( 0.2, 0.6,"Tally ho");

        font = new Font("SansSerif", Font.BOLD, 60);
        StdDraw.setFont( font);
        StdDraw.setPenColor( Color.WHITE );
        StdDraw.text( 0.3, 0.5, "Awesome!", -90.0, Color.BLACK);
    }
